        ...
        >
          <div className="flex flex-col gap-4">
            <label className="flex flex-col gap-1.5">
              <span className="text-sm font-medium text-ink">{t("usernameLabel")}</span>
              <input
                autoFocus
                value={username}
            ...
            <label className="flex flex-col gap-1.5">
              <span className="text-sm font-medium text-ink">{t("passwordLabel")}</span>
              <div className="relative flex items-center">
                ...
                <button
                  ...
                  className="absolute right-2.5 p-1 rounded text-ink-soft hover:text-ink focus:outline-none focus:ring-1 focus:ring-pine/30 transition-colors cursor-pointer"
                  aria-label={showPassword ? t("hidePasswordAria") : t("showPasswordAria")}
                  title={showPassword ? t("hidePasswordAria") : t("showPasswordAria")}
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-1 rounded-md bg-pine px-3 py-2 text-sm font-medium text-surface transition-opacity hover:opacity-90 disabled:opacity-50 cursor-pointer"
            >
